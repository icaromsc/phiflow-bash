...
eval $(parse_yaml config_sepsis.yaml)
...
EOF
    ...
    bash scripts/obtain_kraken2_scores.sh $sample $kraken2_db_path $conifer_path $workdir_results
...
/mnt/storwize/opt2/R-4.1.1/bin/Rscript --vanilla scripts/join_kraken_plus_confidence_reports.R ${workdir_results}/taxonomy_classification
